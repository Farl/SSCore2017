...
namespace SS
{
    ...
    public static class ProjectSettingsUISync
    {
        private static T GetInstance<T>() where T : ProjectSettingsObjectSync<T>
        {
            var t = typeof(T);
        ...
        public static SettingsProvider Register<T>(string label = null, HashSet<string> searchKeywords = null) where T : ProjectSettingsObjectSync<T>
        {
